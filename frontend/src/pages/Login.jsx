        ...
        <section className="bg-white">
            <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
                <section className="relative flex h-32 items-end bg-gray-900 lg:col-span-5 lg:h-full xl:col-span-6">
                    <img
                        alt=""
                        src="https://www.lego.com/cdn/cs/set/assets/blt5076c7c0275e65d6/07_Family-Homepage_APHB-Mobile.png?format=webply&fit=crop&quality=70&width=800&dpr=1.5"
                    ...
                    <div className="hidden lg:relative lg:block lg:p-12">
                        ...
                        <h2 className="mt-6 text-2xl font-bold text-white sm:text-3xl md:text-4xl">
                            Welcome Back to LEGO Builder
                        </h2>

                        <p className="mt-4 leading-relaxed text-white/90">
                            Login to continue building and sharing your LEGO creations!
                        </p>
                    </div>
                </section>
                ...
                <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
                    <div className="max-w-xl lg:max-w-3xl">
                        ...
                        <form onSubmit={handleSubmit} className="mt-8 grid grid-cols-6 gap-6">
                            ...
                            <div className="col-span-6">
                                <label htmlFor="Remember" className="flex gap-4">
                                    <input
                                        type="checkbox"
                                        id="Remember"
                                        name="remember"
                            ...
                            <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                                <p className="mt-4 text-sm text-gray-500 sm:mt-0">
                                    ...
                                    <Link to="/register" className="text-gray-700 underline ml-1">Sign up</Link>.
                                </p>
                            </div>
                        </form>
                    </div>
